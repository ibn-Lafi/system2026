...
export default async function PosPage() {
  ...
  type TerminalRow = { name: string };

  const [{ data: products }, { data: stock }, { data: terminal }] = await Promise.all([
  ...
  return <PosScreen products={posProducts} terminalName={terminal?.name ?? "الكاشير"} />;
}
